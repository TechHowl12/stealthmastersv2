  ...
  return (
    ...
    <nav className='flex justify-between items-center py-4 px-2 sm:px-10 md:py-6'>
      ...
      <section className='w-full flex px-2 mt-5 sm:mt-0 sm:px-10 justify-center items-center'>
            <div className='w-2/12 sm:pl-0 md:pl-[0.5%] lg:pl-[2.5%] xl:pl-[3.5%] 2xl:pl-[5%] sm:mb-20 mb-8'>
               ...
               <div className='absolute bg-[#ffffffb5] w-auto sm:py-7 py-3 pr-3 md:pr-6 lg:pr-10 xl:pr-16 text-[7px] sm:text-xs  md:text-sm lg:text-lg xl:text-xl 2xl:text-xl text-[#807316] mt-2 sm:mt-4 rounded-lg'>
      ...
      <section className='w-full flex px-2 sm:px-10 justify-center items-center mt-8 sm:mt-14'>
      ...
      <section className='w-full flex justify-center items-center sm:items-start mt-10 sm:mt-16 px-2'>
    ...
    <section className='mt-10'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-7 px-2 sm:px-10 xl:px-32 mt-10'>
            <div className='bg-[#e6dcc8ad] p-3 sm:p-10 rounded-xl'>
                <h1 className='font-bold text-sm sm:text-[2vw] 2xl:mb-6 mb-3'>Expansive Concealment Bay</h1>
            ...
            <div className='bg-[#e6dcc8ad] p-3 sm:p-10 rounded-xl'>
                <h1 className='font-bold text-sm sm:text-[2vw] 2xl:mb-6 mb-3'>Customize Your Storage Space</h1>
            ...
            <div className='bg-[#e6dcc8ad] p-3 sm:p-10 rounded-xl'>
                <h1 className='font-bold text-sm sm:text-[2vw] 2xl:mb-6 mb-3'>Designed For Functionality</h1>
            ...
            <div className='bg-[#e6dcc8ad] p-3 sm:p-10 rounded-xl'>
                <h1 className='font-bold text-sm sm:text-[2vw] 2xl:mb-6 mb-3'>Masterfully Crafted</h1>
